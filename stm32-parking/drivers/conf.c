...
void PWM_Conf(void)
{
  ...
  TM4_TB_Config.TIM_Period=20000;//T=Period*t_step=2.5ms
  TM4_TB_Config.TIM_Prescaler=72-1;//t_step=(Prescaler+1)/core_clock=0.5us
...
void GPIO_Conf(void)
{
  ...
  //红外
  GPIO_InitStructure.GPIO_Pin = TRIG1_Pin | TRIG2_Pin | TRIG3_Pin; 
